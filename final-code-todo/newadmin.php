...
<nav id="navigatie">
    ...
    <form class="form-horizontal" action="newadmin.php" method="post" style="text-align: center;">
        <input type="hidden" name="username" value="<?php echo $_GET['user'];?>"/>
            <p class="alert alert-error">Ben je zeker dat je <?php echo $_GET['user']; ?> admin wilt maken?</p>
